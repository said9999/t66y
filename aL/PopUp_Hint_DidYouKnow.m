...
@implementation PopUp_Hint_DidYouKnow
...
+(id)sharedInstance
{
    static PopUp_Hint_DidYouKnow *instance;
...
-(id)init
{
    ...
    if(self)
    {
        NSArray *theView = [[NSBundle mainBundle]loadNibNamed:@"PopUp_Hint_DidYouKnow" owner:self options:nil];
        ...
        [scrollView setContentSize:CGSizeMake(innerView.frame.size.width,300)];
